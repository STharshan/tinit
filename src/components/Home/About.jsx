...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: `I recently had my car windows tinted by King of Tints, and I couldn’t be happier with the results! The tint looks sleek and professional — exactly what I wanted.`,
    name: "Shamim Miah",
  },
